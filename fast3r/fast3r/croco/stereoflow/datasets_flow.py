...
class MPISintelDataset(FlowDataset):
    ...
    def finalize_submission(self, outdir):
        ...
        bundle_exe = "/path/to/StereoFlow/MPI-Sintel/bundler/linux-x64/bundler"  # eg <bundle_exe> <path_to_results_for_clean> <path_to_results_for_final> <output/bundled.lzma>
